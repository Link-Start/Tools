#
#  Be sure to run `pod spec lint TestPodPublic.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = "MIT" #许可证书类型,要和仓库的LICENSE的类型一直
  ...
  s.author             = { "Link_Start" => "532471002@qq.com" } #作者名称和邮箱
  # Or just: s.author    = "Link_Start"
  # s.authors            = { "Link_Start" => "532471002@qq.com" }
  # s.social_media_url   = "http://twitter.com/Link_Start" #作者主页
  ...
  # 代码的clone地址 和 tag版本
  s.source       = { :git => "https://github.com/Link-Start/TestPodPublic.git", :tag => "#{s.version}" }
