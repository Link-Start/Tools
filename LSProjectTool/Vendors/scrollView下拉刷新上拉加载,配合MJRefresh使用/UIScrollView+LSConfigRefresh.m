//
//  UIScrollView+LSConfigRefresh.m
//  LSProjectTool
//
...
#import "UIScrollView+LSConfigRefresh.h"
#import "YYKit.h"

static NSArray *_animations;

@implementation UIScrollView (LSConfigRefresh)
...
/// 刚开始加载数据时 不显示 “点击或上拉加载更多”
/// 当首页的数据不能填满整个屏幕的时候让底部不显示“点击或上拉加载更多”，仅仅在上拉加载的时候能显示上拉加载更多
/// 配置  下拉刷新、上拉加载更多
- (void)configNormalRefreshHeaderAndFooterWithBeginRefresh:(void(^)(void))beginRefreshBlock {
    ...
    MJRefreshBackNormalFooter *normalFooter = [MJRefreshBackNormalFooter footerWithRefreshingTarget:self refreshingAction:@selector(loadMoreData)];
...
//    gifHeader.stateLabel.textColor = ThemeColor;
    ...
    [gifFooter setTitle:@"" forState:MJRefreshStateIdle];// 设置 不显示 “点击或者上拉加载更多文字”
