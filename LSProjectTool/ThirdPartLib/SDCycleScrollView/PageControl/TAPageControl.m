...
/// 圆点的数量不能控制，所以这里控制宽度没有用，圆点的frame还是会跑偏
...
//    // 计算出来的 size，所有的点 占据的总 size
//    CGSize calculateTotalSize = CGSizeMake((self.dotSize.width + self.spacingBetweenDots) * pageCount - self.spacingBetweenDots, self.dotSize.height);
//    if (!self.superview) {
//        return calculateTotalSize;
//    }
//
//    // 一个 圆点+间隔 占据的宽度
//    NSInteger dotOccupyWidth = self.dotSize.width + self.spacingBetweenDots;
//    // 占据的总宽度
//    NSInteger totalWidth = calculateTotalSize.width + self.spacingBetweenDots;
//    // 实际最大宽度
//    NSInteger actualMaxWidth = self.superview.bounds.size.width; // 实际最大宽度
//
//    do {
//        calculateTotalSize.width = calculateTotalSize.width - dotOccupyWidth;
//    } while (calculateTotalSize.width > actualMaxWidth);
//
//
//    return calculateTotalSize;
}
