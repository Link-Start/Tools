...
/**
 ...
 设置背景色，必须一整个富文本都要设置背景色，可以分段设置不同的背景颜色，但是不能有一部分不设置背景色，
 否则，可能会导致整体的富文本都不显示背景色
...
///// 附件 文本空格宽度， 文本左侧/右侧 空格占位宽度
//@property (nonatomic, readonly) CGFloat attachTextSpaceWidth;
//- (NSMutableAttributedString *)attachTextSpaceWidth:(CGFloat)spaceWidth;
