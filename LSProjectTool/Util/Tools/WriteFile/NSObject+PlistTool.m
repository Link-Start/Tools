...
/// 根据文件名删除文件
- (void)deleteFile:(NSString *)plistFileName {
    
    // 获取Documents 中的文件的路径
    NSString *thePath = [self getDocumentFilePath:plistFileName];
    //创建文件管理器
    ...
    NSError *error = nil;
    [[NSFileManager defaultManager] removeItemAtPath:plistFileName error:&error];
