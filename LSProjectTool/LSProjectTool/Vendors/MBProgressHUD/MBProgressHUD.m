...
@property (atomic, MB_STRONG) NSTimer *graceTimer;//执行一次：在show方法触发后到HUD真正显示之前,前提是设定了graceTime，默认为0
@property (atomic, MB_STRONG) NSTimer *minShowTimer;//执行一次：在HUD显示后到HUD被隐藏之前
